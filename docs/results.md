...
Living record of measured F1@50 numbers, what produced them, and how much to trust them.
Newest run first. Reference targets and known divergences live in
`docs/differences-from-published-results.md`; this doc is the numbers themselves.

---

## Run `20260911-114547` — first run to produce a complete answer
